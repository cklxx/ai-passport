...
- [feishu-messenger.md](feishu-messenger.md): direct-device Feishu conversations, messages, voice transcription, reply confirmation, provisioning, persistence, and runtime boundaries.
